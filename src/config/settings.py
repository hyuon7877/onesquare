...
MIDDLEWARE = [
    ...
    # 기존 인증 시스템 미들웨어 (필요시 활성화)
    # 'apps.auth_system.middleware.MaintenanceModeMiddleware',
    # 'apps.auth_system.middleware.UserSessionMiddleware',
    # 'apps.auth_system.middleware.UserActivityLoggingMiddleware',
]
...
# Security Settings (강화된 보안 설정)
SECURE_BROWSER_XSS_FILTER = True
SECURE_CONTENT_TYPE_NOSNIFF = True
SECURE_REFERRER_POLICY = 'strict-origin-when-cross-origin'

# HTTPS 설정 (개발 환경에서도 적용 - PWA 요구사항)
if not DEBUG:
